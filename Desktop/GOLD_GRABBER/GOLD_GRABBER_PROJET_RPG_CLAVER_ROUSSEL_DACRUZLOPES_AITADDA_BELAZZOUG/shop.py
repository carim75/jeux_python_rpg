...
def boutique(window) :
    ...
    def back (window1,window2):
        window1.withdraw()
        window2.deiconify()
    nombre_clic  = IntVar(Window_shop,value= 0 ) 
    ...
    number_item_1=Label(Window_shop,text=lettre, font=("Super Legend Boy",20), bg= 'black',fg='white',height=3,width=5 )
    number_item_1.grid(row=0,column=1,pady=5)
    Button_item_1=Button(Window_shop, text="750", font=("Super Legend Boy",20), bg= 'black',fg='white',height=3,width=5,relief=GROOVE, bd=7.5,command=lambda:add_passage(lettre,number_item_1))
    ...
    number_item_2=Label(Window_shop,text=lettre, font=("Super Legend Boy",20), bg= 'black',fg='white',height=3,width=5 )
    number_item_2.grid(row=1,column=1,pady=5)
    Button_item_2=Button(Window_shop, text="500", font=("Super Legend Boy",20), bg= 'black',fg='white',height=3,width=5,relief=GROOVE, bd=7.5,command=lambda:add_passage(lettre,number_item_1))
    ...
    number_item_3=Label(Window_shop,text=lettre, font=("Super Legend Boy",20), bg= 'black',fg='white',height=3,width=5 )
    number_item_3.grid(row=2,column=1,pady=5)
    Button_item_3=Button(Window_shop, text="250", font=("Super Legend Boy",20), bg= 'black',fg='white',height=3,width=5,relief=GROOVE, bd=7.5,command=lambda:add_passage(lettre,number_item_1))
