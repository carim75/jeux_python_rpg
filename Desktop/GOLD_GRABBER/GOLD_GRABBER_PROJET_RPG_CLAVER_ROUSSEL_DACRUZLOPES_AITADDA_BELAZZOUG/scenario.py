...
def debut (window,coins) :
    ...
    def callback(coins):
        ...
        tp(window_scenario,coins,Inventaire)
    
    #fonction pour changer le texte a l'aide d'un bouton
    nombre_clic  = IntVar(window_scenario,value= 0 ) 
    def add_passage (coins,texte_scenario,id_face,affichage_image_face):
    ...
    bouton_scenario=Button(lieu_texte_scenario,image=bouton_image,bg='black',bd =0 ,width=85,height=85, highlightthickness= 0, command= lambda :add_passage(coins,texte_scenario,id_face,affichage_image_face))
