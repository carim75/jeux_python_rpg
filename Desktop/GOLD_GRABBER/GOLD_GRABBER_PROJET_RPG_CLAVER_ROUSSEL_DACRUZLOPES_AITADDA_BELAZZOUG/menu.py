...
window_menu.minsize(width=1600, height=900)
...
#bouton menu
start_bouton = Button(lieu_bouton_menu, text="start game", font=("Super Legend Boy",30), bg= 'black',fg='white',width="10",relief=GROOVE, bd=7.5,command= lambda: debut(window_menu,coins))
start_bouton.pack(pady=20,anchor=N)
info_bouton = Button(lieu_bouton_menu, text="info", font=("Super Legend Boy",30), bg= 'black',fg='white',width="10",relief=GROOVE, bd=7.5,command=lambda: rule(window_menu))
